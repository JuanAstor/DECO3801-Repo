...
<?php //upload a file to the database
	...
	$uID = $_POST['user']; //the userID, to be replaced with the session var 
	$assignmentID = $_POST['assign']; //the assignmentID, to be replaced with a session var
	
	echo "Number of files submitted: ".count($_POST['filepath']). "<br>";
