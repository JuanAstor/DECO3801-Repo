...
function insert_file_data($userID, $assignmentID, $filename, $content, $dateTime) {
    $query = MySQL::getInstance()->query("INSERT INTO `assignmentfile` (`AssignmentID`, `UserID`, `FileName`, `FileData`, `SubmissionTime`)
                                          VALUES ('" . $assignmentID . "', '" . $userID . "', '" . $filename . "', '" . $content . "', '" . $dateTime . "')");
}
